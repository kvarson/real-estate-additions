...
export const SEO_DEFAULTS = {
  ...
  description: 'Professional real estate development company specializing in commercial and residential projects in Baku, Azerbaijan.',
  keywords: 'real estate, development, Baku, Azerbaijan, commercial, residential, property',
