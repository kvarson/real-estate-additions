...
function convertToProjectData(project: Project): ProjectData {
  return {
    ...
    // İlişkisel diziler - Updated to match the desired nested structure
    interiorImages: project.interiorImages?.map(img => ({
      id: img.id,
      imageUrl: img.imageUrl,
      caption: img.caption ?? undefined
    })) ?? [],
    constructionImages: project.constructionImages?.map(img => ({
      id: img.id,
      imageUrl: img.imageUrl
    })) ?? [],
    apartmentLayouts: project.apartmentLayouts?.map(layout => ({
      id: layout.id,
      ...
      roomArea: layout.roomArea ? Number(layout.roomArea) : undefined,
      kitchenArea: layout.kitchenArea ? Number(layout.kitchenArea) : undefined,
      bathroomArea: layout.bathroomArea ? Number(layout.bathroomArea) : undefined,
      balconyArea: layout.balconyArea ? Number(layout.balconyArea) : undefined
    })) ?? []
  };
}
      ...
      try {
        projects = await Project.findAll({
          ...
          include: [
            ...
            { model: ProjectInteriorImage, as: 'interiorImages' },
            { model: ProjectConstructionImage, as: 'constructionImages' },
            { model: ProjectApartmentLayout, as: 'apartmentLayouts' }
          ]
        });
      } catch (includeError) {
        console.warn('İlişkisel veriler yüklenirken hata oluştu, sadece temel proje verileri yükleniyor:', includeError);
  ...
  static async getProjectById(id: number): Promise<ProjectData | null> {
    try {
      ...
      try {
        ...
        console.warn('İlişkisel veriler yüklenirken hata oluştu, sadece temel proje verisi yükleniyor:', includeError);
  ...
  static async createProject(data: CreateProjectData): Promise<ProjectData> {
    try {
      ...
      const project = await Project.create({
        ...
        featureDescription: data.featureDescription?.trim() || undefined,
        featureImageUrl: data.featureImageUrl?.trim() || undefined,
        generalPlanImageUrl: data.generalPlanImageUrl?.trim() || undefined
      });
      ...
      if (data.constructionImages && data.constructionImages.length > 0) {
      ...
      if (data.featureTitle || data.featureDescription || data.featureImageUrl) {
      ...
      if (data.generalPlanImageUrl || data.catalogUrl) {
        await ProjectPlan.create({
          projectId: project.id,
          generalPlanImageUrl: data.generalPlanImageUrl || undefined,
      ...
      try {
        ...
        console.warn('İlişkisel veriler yüklenirken hata oluştu, temel proje verisi döndürülüyor:', includeError);
  ...
  static async updateProject(id: number, data: UpdateProjectData): Promise<ProjectData> {
    try {
      ...
      const updatedProject = await project.update({
        ...
        ...(data.description !== undefined && { description: data.description !== null ? data.description.trim() : null }),
        ...(data.imageUrl !== undefined && { imageUrl: data.imageUrl !== null ? data.imageUrl.trim() : null }),
        // Yeni eklenen alanlar
        ...(data.location !== undefined && { location: data.location !== null ? data.location.trim() : null }),
        ...(data.status !== undefined && { status: data.status !== null ? data.status.trim() : null }),
        ...(data.year !== undefined && { year: data.year }),
        ...(data.area !== undefined && { area: data.area !== null ? data.area.trim() : null }),
        ...(data.block !== undefined && { block: data.block }),
        // Yeni eklenen ilişkisel alanlar
        ...(data.headerImageUrl !== undefined && { headerImageUrl: data.headerImageUrl !== null ? data.headerImageUrl.trim() : null }),
        ...(data.catalogUrl !== undefined && { catalogUrl: data.catalogUrl !== null ? data.catalogUrl.trim() : null }),
        ...(data.featureTitle !== undefined && { featureTitle: data.featureTitle !== null ? data.featureTitle.trim() : null }),
        ...(data.featureDescription !== undefined && { featureDescription: data.featureDescription !== null ? data.featureDescription.trim() : null }),
        ...(data.featureImageUrl !== undefined && { featureImageUrl: data.featureImageUrl !== null ? data.featureImageUrl.trim() : null }),
        ...(data.generalPlanImageUrl !== undefined && { generalPlanImageUrl: data.generalPlanImageUrl !== null ? data.generalPlanImageUrl.trim() : null })
      } as any);
      ...
      if (data.featureTitle !== undefined || data.featureDescription !== undefined || data.featureImageUrl !== undefined) {
        ...
        if (existingFeature) {
          await existingFeature.update({
            title: data.featureTitle !== null ? data.featureTitle : undefined,
            description: data.featureDescription !== null ? data.featureDescription : undefined,
            imageUrl: data.featureImageUrl !== null ? data.featureImageUrl : undefined
          });
        } else if (data.featureTitle || data.featureDescription || data.featureImageUrl) {
          await ProjectFeature.create({
            projectId: id,
            title: data.featureTitle || undefined,
            description: data.featureDescription || undefined,
      ...
      if (data.generalPlanImageUrl !== undefined || data.catalogUrl !== undefined) {
        ...
        if (existingPlan) {
          await existingPlan.update({
            generalPlanImageUrl: data.generalPlanImageUrl !== null ? data.generalPlanImageUrl : undefined,
            catalogUrl: data.catalogUrl !== null ? data.catalogUrl : undefined
          });
