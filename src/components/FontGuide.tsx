     ...
     return (
          <div className="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto">
               ...
               <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                         ...
                         <div className="space-y-3">
                              <div className="bg-gray-50 p-3 rounded">
                                   ...
                                   <div className="font-cinzel mt-2">
                                        Normal Cinzel fontu
                                   </div>
                              </div>
                              <div className="bg-gray-50 p-3 rounded">
                                   ...
                                   <div className="font-cinzel-decorative mt-2">
                    ...
                    <div>
                         ...
                         <div className="space-y-2">
                              ...
                              <div className="font-cinzel font-medium">
                                   Medium (500)
                              </div>
                    ...
                    <div className="space-y-4">
                         <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                              ...
                              <p className="font-cinzel text-gray-700">
                                   Ana başlıklar için{' '}
                                   <code>font-cinzel-decorative</code> ve{' '}
                                   <code>font-bold</code> kullanın.
                              </p>
                         </div>
                         ...
                         <div className="p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg">
                              ...
                              <p className="text-gray-700">
                                   Alt başlıklar için <code>font-cinzel</code>{' '}
                                   ve <code>font-semibold</code> kullanın.
                              </p>
                         </div>
                         ...
                         <div className="p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-lg">
                              <p className="font-cinzel text-base text-gray-800 leading-relaxed">
                                   ...
                                   <code>font-cinzel</code> ve{' '}
                                   <code>font-normal</code>
                                   kullanarak okunabilirliği koruyun. Bu font
                                   özellikle lüks ve premium projeler için
                                   uygundur.
                              </p>
                         </div>
                    </div>
               ...
               <div className="mt-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
                    <h4 className="font-cinzel font-semibold text-blue-900 mb-2">
                         💡 İpuçları
                    </h4>
                    <ul className="text-blue-800 space-y-1 text-sm">
                         <li>
                              • Başlıklar için{' '}
                              <strong>Cinzel Decorative</strong> kullanın
                         </li>
                         <li>
                              • Uzun metinler için{' '}
                              <strong>Cinzel Normal</strong> tercih edin
                         </li>
                         <li>• Font ağırlıkları ile hiyerarşi oluşturun</li>
                         <li>• Türkçe karakterler tam destekleniyor</li>
                         <li>
                              • Responsive tasarımda font boyutlarını ayarlayın
                         </li>
                    </ul>
               </div>
          </div>
