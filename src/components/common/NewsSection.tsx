...
const NewsSection: React.FC<NewsSectionProps> = ({ articles }) => {
    ...
    const steps = [
        { id: 'arashdirma', no: "1", title: t('step1.title'), description: t('step1.description') },
        { id: 'layihe', no: "2", title: t('step2.title'), description: t('step2.description') },
        { id: 'inshaat', no: "3", title: t('step3.title'), description: t('step3.description') },
        { id: 'satis', no: "4", title: t('step4.title'), description: t('step4.description') },
    ];
            ...
            <div className="container mx-auto px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                    ...
                    <div className="max-w-lg">
                     <h2 className="text-4xl md:text-5xl font-semibold  font-cinzel text-white">{t('title')}</h2>
                    ...
                    <div className="relative">
                        ...
                        {steps.map((step, index) => {
                            ...
                            return (
                                <div key={step.id} className="relative pl-12 pb-12">
                                    {/* Numara (Çember) */}
                                    ...
                                    {index !== steps.length - 1 && 
                                        <div 
                                            className={`absolute left-[18px] top-9 h-[calc(100%-36px)] w-px transition-colors duration-500 ${
                                                isActive ? 'bg-blue-500/50' : 'bg-zinc-800'
                                            }`}
                                        ></div>
                                    }
                                </div>
