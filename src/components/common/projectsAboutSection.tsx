    ...
    <section className="bg-white py-20 px-6">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          {/* Sol Sütun */}
          <div>
            <h2 className="text-4xl font-bold text-gray-800 mb-6">LAYİHƏ HAQQINDA</h2>
            ...
            <button className="border border-black text-black font-semibold py-3 px-6 rounded-md hover:bg-black hover:text-white transition-all duration-300 flex items-center group">
              KATALOQ YÜKLƏ <span className="ml-2 transform group-hover:translate-x-1 transition-transform">→</span>
            </button>
          </div>
        ...
        <div className="mt-20">
          <img
            src={project?.image || "https://placehold.co/1200x600/f0f0f0/cccccc?text=Bina+Modeli"}
            alt="Proje Modeli"
