...
const ServicesSection: React.FC<ServicesSectionProps> = ({ projects: initialProjects, error: initialError }) => {
      ...
      const fetchProjects = async () => {
        try {
          ...
          if (result.success) {
            ...
            setError(result.message || 'Projeler yüklenirken bir hata oluştu.');
          }
        } catch (err) {
          console.error('Hizmetler bölümü proje verilerini çekerken hata:', err);
    ...
    <section className="bg-[#ffff] py-16">
      <div className="px-4 md:px-12">
        ...
        <div className="max-w-2xl mt-32 ml-4">
          <h2 className="text-4xl md:text-5xl font-serif tracking-widest">LAYİHƏLƏRİMİZ</h2>
          <p className="mt-4 text-xl text-[#4B4B4B]">Explore a diverse range of projects that highlight our innovation, expertise, and dedication to delivering exceptional results.</p>
        </div>
