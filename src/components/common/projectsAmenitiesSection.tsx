     ...
     const amenities = [
          {
               ...
               description:
                    'Həyətyanı ərazidə sakinlərin fiziki sağlamlığı üçün idmanla məşğul olmaq və asudə vaxtını səmərəli keçirmək üçün şərait yaradılıb.',
                    ...
                    {amenities.map((item, index) => (
                         ...
                         >
                              <div className="absolute inset-0 bg-black bg-opacity-50 group-hover:bg-opacity-70 transition-all duration-300 flex flex-col justify-end p-8 text-white">
                                   ...
                                   {item.description && (
                                        <p className="text-sm opacity-0 group-hover:opacity-100 max-h-0 group-hover:max-h-40 overflow-hidden transition-all duration-500">
                                             {item.description}
                                        </p>
                                   )}
                              </div>
