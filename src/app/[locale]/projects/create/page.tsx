...
export default async function CreateProjectPage({ params, searchParams }: PageProps) {
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 font-cinzel-decorative">Yeni Proje Oluştur</h1>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-sm text-blue-700">
            Bu form direkt PostgreSQL veritabanına bağlanır ve Sequelize ORM kullanarak 
            veriyi kaydeder. MVC yapısında Server Actions kullanılarak form submission işlenir.
          </p>
        </div>
      </div>
    </div>
